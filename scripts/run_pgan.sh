...
# MR 3T -> 7T
python misalign/train.py model='pgan.yaml' data.misalign_x=0 data.misalign_y=0 data.degree=0 data.motion_prob=0 data.deform_prob=0
python misalign/train.py model='pgan.yaml' data.misalign_x=0 data.misalign_y=5 data.degree=2.5 data.motion_prob=0 data.deform_prob=0