...
from misalign.data.components.transforms import download_process_MR_3T1_7T1, dataset_MR_3T1_7T1

class MR_3T1_7T1_DataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str = "data/",
    ...
    def prepare_data(self):
        ...
        for phase in ['train','val','test']:
            ...
            if os.path.exists(write_dir):
                ...
                download_process_MR_3T1_7T1(target_file, write_dir, mis_x, mis_y, Rot_z, M_prob, D_prob) # call function
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.data_train = dataset_MR_3T1_7T1(self.train_dir, reverse= self.hparams.reverse, flip_prob=self.hparams.flip_prob, rot_prob=self.hparams.rot_prob, rand_crop=self.hparams.rand_crop) # Use flip and crop augmentation for training data
        self.data_val = dataset_MR_3T1_7T1(self.val_dir, reverse= self.hparams.reverse, flip_prob=0.0, rot_prob=0.0)
        self.data_test = dataset_MR_3T1_7T1(self.test_dir, reverse= self.hparams.reverse, flip_prob=0.0, rot_prob=0.0)
...
if __name__ == "__main__":
    _ = MR_3T1_7T1_DataModule('C:/Users/NUGURI/Workspace/2023.08.22_misalign_CBM/data/MR_3T2_7T1_s')  # TODO
    _.prepare_data()
    _.setup()
