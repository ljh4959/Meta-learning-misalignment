...
from misalign.data.components.transforms_fly import dataset_IXI_FLY
...
class ProposedModule_A_to_B(BaseModule_A_to_B):
    ...
    def __init__(
        ...
        **kwargs: Any
        ...
        if self.params.flag_meta_learning:
            ...
            self.data_meta = dataset_IXI_FLY(
                rand_crop=True,
    ...
    def training_step(self, batch: Any, batch_idx: int):
        ...
        if self.current_epoch > -1 and self.params.flag_meta_learning:
            ...
            meta_real_a, meta_real_b = next(iter(self.clean_dloader))

            meta_real_a, meta_real_b = (
            ...
            del meta_real_a, meta_real_b  # remove this
